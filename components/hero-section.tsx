    ...
    <section id="hero" className="relative" style={{ backgroundColor: 'var(--hero-navy)' }}>
      ...
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="block sm:hidden pt-4 pb-8 flex flex-col items-center">
          <div className="rounded-2xl bg-white shadow-2xl shadow-black/40 overflow-hidden w-full" style={{ position: 'relative', zIndex: 50, isolation: 'isolate', borderRadius: '16px', WebkitMaskImage: 'radial-gradient(white, white)', WebkitBackfaceVisibility: 'hidden', MozBackfaceVisibility: 'hidden', transform: 'translateZ(0)' }}>
            <BookingWidget />
          </div>
        </div>
